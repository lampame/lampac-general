...
namespace LMG.StreamData
{
    public class ModInit : IModuleLoaded
    {
        ...
        {
            StreamDataSettings = new OnlinesSettings("LMG.StreamData", "https://streamdata.vaplayer.ru", streamproxy: false, useproxy: false)
            {
            ...
            var conf = ModuleInvoke.Init("LMG.StreamData", defaults);
            ...
            OnlineRegistry.RegisterWithSearch("lmg_streamdata");
        }
